...
parser.add_argument('--image_path', default='/mnt/zhanghaofolder/RTDETR-main/dataset/images/test2007',type=str, help="path of images")
parser.add_argument('--label_path', default='/mnt/zhanghaofolder/RTDETR-main/dataset/labels/test2007',type=str, help="path of labels .txt")
